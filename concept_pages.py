...
_L9 = {
    ...
    # ---- 9REV Revision ----
    "9REV": {
        "title": "Level 9 Revision — Fractions",
        "intro": [
...
_L13 = {
    ...
    # ---- 13CUM1 Mixed A+B+C ----
    "13CUM1": {
        "title": "Verifying the Index Laws",
        "intro": [
    ...
    # ---- 13CUM2 Mixed D+E+F ----
    "13CUM2": {
        "title": "Surds — Simplifying Square Roots",
        "intro": [
        ...
        "real_life": [
            {"text": "1. sqrt(8) = 2sqrt(2)",
             "diagram": "equation_steps", "steps": ["sqrt(8)", "sqrt(4x2)", "2sqrt(2)"],
             "caption": "pull out the perfect square"},
            {"text": "2. sqrt(18) = 3sqrt(2)",
             "diagram": "equation_steps", "steps": ["sqrt(18)", "sqrt(9x2)", "3sqrt(2)"],
             "caption": "9 is the largest perfect square factor"},
            {"text": "3. 1/sqrt(2) = sqrt(2)/2",
             "diagram": "equation_steps", "steps": ["1/sqrt(2)", "sqrt(2)/sqrt(2)xsqrt(2)", "sqrt(2)/2"],
             "caption": "rationalizing the denominator"},
        ],
        "card": card_fractional_power,
        "solved": [
            {"q": "Ex: Simplify sqrt(50), then add 2sqrt(3) + 5sqrt(3).",
             "steps": ["sqrt(50) = sqrt(25x2) = 5sqrt(2)", "2sqrt(3)+5sqrt(3) = 7sqrt(3)"]},
        ],
        "tips": [
            "Find the largest perfect square factor first.",
            "sqrt(a) x sqrt(b) = sqrt(axb).",
            "Only LIKE surds can be added/subtracted.",
            "Rationalize: multiply top and bottom by the surd.",
        ],
        "try_it": {
            "questions": [
                "1. Simplify sqrt(12).",
                "2. Simplify sqrt(45).",
                "3. Rationalize 1/sqrt(3).",
            ],
            "answers": "1) 2sqrt(3)    2) 3sqrt(5)    3) sqrt(3)/3",
        },
    },
    ...
    "13H": {
        ...
        "intro": [
            ...
            "A virus (10^-7 m) is 100,000 times smaller than an ant (10^-2 m).",
        ],
        "real_life": [
            {"text": "1. Bacterium: about 10^-6 m",
             "diagram": "equation_steps", "steps": ["Bacterium", "~10^-6 m"],
             "caption": "very small"},
            {"text": "2. Human height: about 10^0 m",
             "diagram": "equation_steps", "steps": ["Human height", "~1 m = 10^0 m"],
             "caption": "our everyday scale"},
            {"text": "3. Earth's diameter: about 10^7 m",
             "diagram": "equation_steps", "steps": ["Earth's diameter", "~10^7 m"],
             "caption": "very large"},
        ],
        "card": card_power_concept,
        "solved": [
            {"q": "Ex: Which is bigger, 3x10^5 or 3x10^3?",
             "steps": ["Same leading number (3)", "Compare exponents: 5 > 3", "3x10^5 is bigger (100 times bigger)"]},
        ],
        "tips": [
            "Bigger exponent = bigger number (for positive exponents).",
            "More negative exponent = smaller number.",
            "Compare exponents first, then the leading number.",
            "Scientific notation makes huge size gaps easy to compare.",
        ],
        "try_it": {
            "questions": [
                "1. Which is bigger: 10^4 or 10^-2?",
                "2. Which is bigger: 5x10^3 or 2x10^3?",
                "3. Order from smallest: 10^2, 10^-3, 10^0.",
            ],
            "answers": "1) 10^4    2) 5x10^3    3) 10^-3, 10^0, 10^2",
        },
    },
    ...
    "13CUM3": {
        ...
        "intro": [
            ...
            "Bacteria doubling, population growth: exponential GROWTH.",
            "Radioactive decay, depreciation, medicine leaving the body: exponential DECAY.",
        ],
        "real_life": [
            {"text": "1. Bacteria doubling: 1,2,4,8,16,32",
             "diagram": "equation_steps", "steps": ["1,2,4,8,16,32", "x2 each step", "after 5 steps: 1x2^5=32"],
             "caption": "exponential growth"},
            {"text": "2. Substance halving: 100,50,25,12.5",
             "diagram": "equation_steps", "steps": ["100,50,25,12.5", "/2 each step", "after 3 steps: 100/2^3=12.5"],
             "caption": "exponential decay"},
            {"text": "3. Money tripling: 10,30,90,270",
             "diagram": "equation_steps", "steps": ["10,30,90,270", "x3 each step", "after 3 steps: 10x3^3=270"],
             "caption": "growth with factor 3"},
        ],
        "card": card_power_concept,
        "solved": [
            {"q": "Ex: A colony starts at 2 and triples each hour. Find the size after 4 hours.",
             "steps": ["Size = start x factor^n", "= 2 x 3^4", "= 2 x 81 = 162"]},
        ],
        "tips": [
            "Growth: multiply by the factor each step.",
            "Decay: divide by the factor each step.",
            "After n steps: start x factor^n (growth) or start / factor^n (decay).",
            "Exponential change is NOT the same as adding the same amount each time.",
        ],
        "try_it": {
            "questions": [
                "1. A population starts at 3 and doubles 4 times. Find the size.",
                "2. A substance starts at 80g and halves 3 times. Find the amount.",
                "3. Is 'add 5 each year' growth, decay, or neither?",
            ],
            "answers": "1) 48    2) 10g    3) Neither -- that's LINEAR, not exponential",
        },
    },

    # ---- 13J Mixed challenge ----
    "13J": {
        "title": "Powers & Indices Mastery Challenge",
        "intro": [
            "Every skill: laws of indices, negative/fractional powers, surds, scientific notation, growth/decay.",
            "Match your method to the question -- laws for same-base expressions, roots for fractional powers.",
            "Speed challenge: each question has a point value.",
            "Score yourself: Bronze 20+, Silver 30+, Gold 38+ (all correct).",
        ],
        "real_life": [
            {"text": "1. 2^5 x 2^3 / 2^3 = 2^5",
             "diagram": "equation_steps", "steps": ["2^5 x 2^3 / 2^3", "2^(5+3-3)", "2^5 = 32"],
             "caption": "laws combine"},
            {"text": "2. sqrt(20) = 2sqrt(5)",
             "diagram": "equation_steps", "steps": ["sqrt(20)", "sqrt(4x5)", "2sqrt(5)"],
             "caption": "surd simplification"},
            {"text": "3. 3^(-2) = 1/9",
             "diagram": "equation_steps", "steps": ["3^-2", "1/3^2", "1/9"],
             "caption": "negative power"},
        ],
        "card": card_laws_indices,
        "solved": [
            {"q": "Ex: Simplify 3^4 x 3^2 / 3^3, then simplify sqrt(12).",
             "steps": ["3^4x3^2/3^3 = 3^(4+2-3) = 3^3 = 27", "sqrt(12) = sqrt(4x3) = 2sqrt(3)"]},
        ],
        "tips": [
            "Combine index laws step by step -- don't rush.",
            "Surds: find the largest perfect square factor.",
            "Negative power = reciprocal, NOT a negative answer.",
            "Score every question -- aim for Gold!",
        ],
        "try_it": {
            "questions": [
                "1. Simplify 5^3 x 5^2.",
                "2. Simplify sqrt(27).",
                "3. Evaluate 4^(-2).",
            ],
            "answers": "1) 5^5 = 3125    2) 3sqrt(3)    3) 1/16",
        },
    },
    ...
    "13REV": {
        ...
        "intro": [
            "Power = base^exponent. Multiply same base -> add exponents.",
            "Negative exponent -> reciprocal. Power 1/2 -> square root.",
            "Surds: simplify by pulling out the largest perfect square factor.",
            "Scientific notation: number x 10^power -- compare by exponent first.",
            "Exponential growth (x factor) and decay (/factor) both use powers.",
        ],
        "real_life": [
            {"text": "1. 3^2 = 9",
             "diagram": "power_breakdown", "base": 3, "exp": 2,
